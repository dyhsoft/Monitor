...
public class SysRoleMenuSeedData : ISqlSugarEntitySeedData<SysRoleMenu>
{
    ...
    public IEnumerable<SysRoleMenu> HasData()
    {
        ...
        foreach (var menu in menuList)
        {
            ...
            { 
                Id = menu.Id + (roleList[0].Id % 1300000000000), 
        ...
        foreach (var role in roleList.Skip(1)) 
            roleMenuList.AddRange(otherRoleMenuList.Select(u => new SysRoleMenu { Id = u.Id + (role.Id % 1300000000000), RoleId = role.Id, MenuId = u.Id }));
