...
function loadData() { state.tableData = [{ sensorId: 'P-001', sensorName: '液压支架压力1', status: 1 }, { sensorId: 'P-002', sensorName: '液压支架压力2', status: 1 }]; }
</script>
