        ...
        <div class="right-content">
            <el-card shadow="hover">
                <el-form :inline="true">
                    <el-form-item label="月份">
                        <el-date-picker v-model="state.month" type="month" placeholder="选择月份" value-format="YYYY-MM" />
                    </el-form-item>
            ...
            <el-card shadow="hover" style="margin-top: 10px">
                <el-table :data="state.tableData" v-loading="state.loading" border stripe height="400">
                    ...
                    <el-table-column prop="alarmDuration" label="报警时长(分钟)" align="center" />
                    <el-table-column prop="sensorCount" label="传感器数量" align="center" />
                    <el-table-column prop="onlineRate" label="在线率(%)" align="center" />
                    <el-table-column prop="completeRate" label="数据完整率(%)" align="center" />
                </el-table>
            </el-card>
        </div>
    </div>
...
function loadData() {
    ...
    setTimeout(() => {
        state.tableData = [
            { date: '2026-03-01', alarmCount: 5, alarmDuration: 45, sensorCount: 20, onlineRate: 98.5, completeRate: 99.2 },
            { date: '2026-03-02', alarmCount: 3, alarmDuration: 30, sensorCount: 20, onlineRate: 99.0, completeRate: 98.8 },
        ];
        state.loading = false;
    }, 300);
}
