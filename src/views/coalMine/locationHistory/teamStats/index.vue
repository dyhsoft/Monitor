        ...
        <div class="right-content">
            ...
            <el-card shadow="hover" style="margin-top: 10px">
                <el-table :data="state.tableData" v-loading="state.loading" border stripe height="400">
                    ...
                    <el-table-column prop="avgDuration" label="人均时长(小时)" align="center" />
                    <el-table-column prop="maxPerson" label="最大在岗人数" align="center" />
                </el-table>
            </el-card>
        </div>
    </div>
...
function loadData() {
    ...
    setTimeout(() => {
        state.tableData = [
            { teamName: '采煤一班', inCount: 25, totalHours: 200, avgDuration: 8.0, maxPerson: 18 },
            { teamName: '采煤二班', inCount: 24, totalHours: 192, avgDuration: 8.0, maxPerson: 17 },
            { teamName: '掘进一班', inCount: 15, totalHours: 120, avgDuration: 8.0, maxPerson: 12 },
            { teamName: '掘进二班', inCount: 14, totalHours: 112, avgDuration: 8.0, maxPerson: 11 },
            { teamName: '机电班', inCount: 10, totalHours: 80, avgDuration: 8.0, maxPerson: 8 },
        ];
        state.loading = false;
    }, 300);
}
