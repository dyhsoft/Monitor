        ...
        <div class="right-content">
            <el-card shadow="hover">
                <el-form :inline="true">
                    <el-form-item label="日期">
                        <el-date-picker v-model="state.dateRange" type="daterange" range-separator="至" start-placeholder="开始" end-placeholder="结束" value-format="YYYY-MM-DD" @change="loadData" />
                    </el-form-item>
            ...
            <el-card shadow="hover" style="margin-top: 10px">
                <el-table :data="state.tableData" v-loading="state.loading" border stripe height="450">
                    ...
                    <el-table-column prop="alarmMessage" label="超员信息" align="center" />
...
import { CoalMineApi, LocationAlarmApi } from '/@/api-services/api';

const state = reactive({
    loading: false, tableData: [] as any[], treeData: [] as any[],
    treeProps: { children: 'children', label: 'name' },
    queryParams: { mineId: null as number | null, alarmType: 2 },
...
function loadData() {
    ...
    state.loading = true;
    const params: any = { mineId: state.queryParams.mineId, alarmType: 2, page: 1, pageSize: 1000 };
