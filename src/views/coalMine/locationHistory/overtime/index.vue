        ...
        <div class="right-content">
            ...
            <el-card shadow="hover" style="margin-top: 10px">
                <el-table :data="state.tableData" v-loading="state.loading" border stripe height="450">
                    ...
                    <el-table-column prop="alarmMessage" label="超时信息" align="center" />
...
const state = reactive({
    ...
    queryParams: { mineId: null as number | null, alarmType: 1 },
...
function loadData() {
    ...
    state.loading = true;
    const params: any = { mineId: state.queryParams.mineId, alarmType: 1, page: 1, pageSize: 1000 };
