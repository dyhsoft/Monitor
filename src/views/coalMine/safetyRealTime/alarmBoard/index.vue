    ...
    <div class="page-layout">
        ...
        <div class="right-content">
            <el-row :gutter="10">
                ...
                <el-col :span="8">
                    <el-card shadow="hover">
                        <template #header>未处理报警</template>
                        <div class="stat-number">{{ state.stats.pendingCount }}</div>
                    </el-card>
                </el-col>
            </el-row>
            <el-card shadow="hover" style="margin-top: 10px">
                <template #header>
                    <span style="font-weight: bold;">实时报警信息</span>
                </template>
                <el-table :data="state.alarmList" border stripe height="350">
                    <el-table-column type="index" label="序号" width="60" align="center" />
                    <el-table-column prop="alarmTime" label="时间" width="100" align="center" />
...
const state = reactive({
    ...
    stats: { alarmCount: 3, todayCount: 15, pendingCount: 2 },
    alarmList: [] as any[]
});
...
function loadAlarm() {
    state.alarmList = [
        { alarmTime: '17:55', sensorName: '甲烷传感器2', alarmType: '超限报警', alarmValue: '0.85%', location: '掘进面1' },
        { alarmTime: '17:50', sensorName: '一氧化碳传感器', alarmType: '超限报警', alarmValue: '35ppm', location: '中央变电所' },
        { alarmTime: '17:45', sensorName: '温度传感器2', alarmType: '故障报警', alarmValue: '--', location: '采煤面A' },
    ];
}
</script>
