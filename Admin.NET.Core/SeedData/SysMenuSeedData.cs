...
public class SysMenuSeedData : ISqlSugarEntitySeedData<SysMenu>
{
    ...
    public IEnumerable<SysMenu> HasData()
    {
        return new[]
        {
            ...
            new SysMenu{ Id=1301000070102, Pid=1301000070001, Title="视频配置", Path="/video/config", Name="videoConfig", Component="coalMine/video/config/index", Icon="ele-Setting", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2026-03-10 00:00:00"), OrderNo=110 },
            new SysMenu{ Id=1301000070103, Pid=1301000070102, Title="查询", Permission="videoConfig:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2026-03-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1301000070104, Pid=1301000070102, Title="新增", Permission="videoConfig:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2026-03-10 00:00:00"), OrderNo=110 },
            new SysMenu{ Id=1301000070105, Pid=1301000070102, Title="编辑", Permission="videoConfig:update", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2026-03-10 00:00:00"), OrderNo=120 },
            new SysMenu{ Id=1301000070106, Pid=1301000070102, Title="删除", Permission="videoConfig:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2026-03-10 00:00:00"), OrderNo=130 },
